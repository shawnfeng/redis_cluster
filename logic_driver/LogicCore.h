...
class LogicCore {
 ...
 LogicCore(LogOut *log,
  ...
  enum {
    ...
    PROTO_TYPE_UPIDX = 4, // 带create 功能，和实际是有区别的
  ...
  enum {
    ...
    PROTO_LEN_UPIDX = PROTO_LEN_GLOBAL_HEAD + PROTO_LEN_SENDIDX + PROTO_LEN_RECVIDX + PROTO_LEN_UID + PROTO_LEN_CLI_TYPE,
